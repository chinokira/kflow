 ...
 * includes custom queries for fetching competitions with their related entities.
 *
 * @author K-FLOW Team
 * @version 1.0
 */
...
public interface CompetitionRepository extends JpaRepository<Competition, Long> {
     ...
     *
     * @param id The ID of the competition
     * @return An Optional containing the competition with all related entities if found, empty otherwise
     */
