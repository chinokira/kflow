...
export const routes: Routes = [
  ...
  { path: 'competitions/new', component: CompetitionFormComponent, canActivate: [authGuard, adminGuard] },
  ...
  { path: 'competitions/:id/edit', component: CompetitionFormComponent, canActivate: [authGuard, adminGuard] },
